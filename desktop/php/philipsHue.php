...
//include_file('core', 'philipsHue', 'config', 'philipsHue');
        ...
        <form class="form-horizontal">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-lg-2 control-label">{{Nom de l'équipement philipsHue}}</label>
                    <div class="col-lg-3">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-1">
                        <input type="checkbox" class="eqLogicAttr bootstrapSwitch" data-l1key="isEnable" checked/>
                    </div>
                    <label class="col-lg-2 control-label" >{{Visible}}</label>
                    <div class="col-lg-1">
                        <input type="checkbox" class="eqLogicAttr bootstrapSwitch" data-l1key="isVisible" checked/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <a class="btn btn-default" id="associateBridge">{{Synchroniser avec le Bridge}}</a>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label">{{Device}}</label>
                    <div class="col-lg-3">
                        <input type="text" id="device" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="device" placeholder="{{Device}}" disabled/>
